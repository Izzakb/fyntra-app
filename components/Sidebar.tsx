...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-72 bg-white dark:bg-slate-950 text-slate-900 dark:text-white border-r border-slate-100 dark:border-slate-900 h-screen sticky top-0 p-8 transition-all duration-300">
      {/* LOGO AREA */}
      <div className="mb-12 px-4">
        <h1 className="text-2xl font-black italic tracking-tighter text-slate-900 dark:text-white">
          FYNTRA<span className="text-blue-500">.</span>
        </h1>
        <p className="text-[8px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-[0.4em] mt-1">
          Faizax Ecosystem
        </p>
      </div>
